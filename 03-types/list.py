...
persons += ('Karel', 20, 'muž'), ('Kateřina', 60, 'žena'), ('Karel', 20, 'muž'), ('Petra', 21, 'žena');
print(persons);
...
women2 = [item[0] for item in persons if item[2] == 'žena']
for woman in women2:
    print(f"{woman}\n{'-'*len(woman)}")
...
ipeople.sort(key=lambda ipeople: ipeople[1], reverse=True)
